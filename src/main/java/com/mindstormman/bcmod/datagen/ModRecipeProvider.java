...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        // Arbutus Wood
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ArbutusWood.ARBUTUS_PLANKS.get(), 9)
                .requires(ArbutusWood.ARBUTUS_LOG.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_LOG.get()), has(ArbutusWood.ARBUTUS_LOG.get()))
                .save(pWriter);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_STAIRS.get(), 4)
                .pattern("#  ")
                .pattern("## ")
                .pattern("###")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_PLANKS.get()), has(ArbutusWood.ARBUTUS_PLANKS.get()))
                .save(pWriter);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_SLAB.get(), 3)
                .pattern("###")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_PLANKS.get()), has(ArbutusWood.ARBUTUS_PLANKS.get()))
                .save(pWriter);

        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ArbutusWood.ARBUTUS_BUTTON.get())
                .requires(ArbutusWood.ARBUTUS_PLANKS.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_PLANKS.get()), has(ArbutusWood.ARBUTUS_PLANKS.get()))
                .save(pWriter);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_PRESSURE_PLATE.get())
                .pattern("## ")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_PLANKS.get()), has(ArbutusWood.ARBUTUS_PLANKS.get()))
                .save(pWriter);

        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_FENCE.get(), 3)
                .pattern("#S#")
                .pattern("#S#")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .define('S', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_FENCE_GATE.get())
                .pattern("S#S")
                .pattern("S#S")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .define('S', Items.STICK)
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_DOOR.get(), 3)
                .pattern("## ")
                .pattern("## ")
                .pattern("## ")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ArbutusWood.ARBUTUS_TRAPDOOR.get(), 3)
                .pattern("###")
                .pattern("###")
                .define('#', ArbutusWood.ARBUTUS_PLANKS.get())
                .unlockedBy(getHasName(ArbutusWood.ARBUTUS_PLANKS.get()), has(ArbutusWood.ARBUTUS_PLANKS.get()))
        ...
        (Consumer < FinishedRecipe > pFinishedRecipeConsumer, List < ItemLike > pIngredients, RecipeCategory
        ...
        AbstractCookingRecipe > pCookingSerializer, List < ItemLike > pIngredients, RecipeCategory pCategory, ItemLike
        pResult,float pExperience, int pCookingTime, String pGroup, String pRecipeName){
